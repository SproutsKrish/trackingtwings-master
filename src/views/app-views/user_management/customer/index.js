    ...
    return(
        ...
        <Card title="Customer">
            <Flex alignItems="center" justifyContent="space-between" mobileFlex={false}>
                ...
                <div className="mb-3">
                <Button type="primary" icon={<PlusOutlined/>} onClick={showDrawer} ghost>Add Customer</Button>
				</div>
		...
		<Drawer placement="right" closable={false} onClose={onClose} open={open}>
			<div className='container' >
				...
				<Form name="customer_add"> 
					<Form.Item name="customer_name" rules={[{required:true,message:'Customer Name is Required!'}]}>
						<Input type='text' placeholder='Customer Name'/>
					</Form.Item>
					<Form.Item name="mobile_number" rules={[{required:true,message:'Mobile Number is Required!'}]}>
						<Input type='text' placeholder='Mobile Number'/>
					</Form.Item>
					<Form.Item name="password" rules={[{required:true,message:'Password is Required!'}]}>
						<Input type='password' placeholder='Password'/>
					</Form.Item>
					<Form.Item name="confirm_password" rules={[{required:true,message:'Confirm Password is Required!'}]}>
